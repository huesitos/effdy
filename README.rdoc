...
A+ runs with MongoDB. To install it, follow the corresponding guide in the manual[http://docs.mongodb.org/manual/installation/] based on your OS. A mongod process should be running before starting the rails server.
