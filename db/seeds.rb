...
topic = Topic.create(title: 'Capital cities', reviewing: false, review_configuration: 'normal')
...
topic1 = ps200.topics.create(title: 'American Political Culture', reviewing: false, review_configuration: 'normal')
